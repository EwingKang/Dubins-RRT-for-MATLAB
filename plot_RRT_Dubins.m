function plot_RRT_Dubins(gca, vertecies, edges, vert_count)

scatter(gca, vertecies(1,1), vertecies(1,2), 45, '*','r','LineWidth',1); hold on;
scatter(gca, vertecies(:,1), vertecies(:,2), 10,linspace(1,10,length(vertecies(:,1))),'filled'); hold on;
